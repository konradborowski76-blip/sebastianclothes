...
// Bezpieczny obrazek z automatycznym "zamiennikiem", gdy URL się nie wczyta
function SafeImg({
  src,
  alt,
  className,
...
const PRODUCTS: Product[] = [
  ...
  { id: 'd10',name: 'Sukienka Kaja – koronkowa',       price: 27900, rating: 4.7, reviews: 95,  sizes: ['S','M','L'], colors: ['ecru','czarna'], category: 'Sukienki', image: 'https://images.unsplash.com/photo-1512436991641-6745cdb1723f?q=80&w=1600&auto=format&fit=crop' },
];
